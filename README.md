...
![](ckan-kadap-theme.png)

## 목적 
국내 자동차 데이터 활용활성화를 위해서 [산업통상자원부](https://www.motie.go.kr/)와 [한국자동차연구원](https://www.katech.re.kr)은 2021년부터 [자동차데이터포털](https://portal.bigdata-car.kr)을 구축하여 운영중에 있습니다. 

국내 자동차 산업계에서 손쉽게 데이터 포털을 구축 활용하기 위하여 **자동차데이터포털**의 **서브포털**을 CKAN을 통해 제공하고 있으며, 자동차데이터포털의 스타일(Theme)에 맞게 일부 수정 하여 배포 합니다. 
